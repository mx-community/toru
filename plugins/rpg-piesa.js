...
//conn.sendMessage(m.chat, { text: noXd, mentions: [m.sender], contextInfo: { externalAdReply: { title: "Piesas de recompensa.", body: "¡Tienes que reunir 10 piesas para ver la imagen!", thumbnail: thumbNo, sourceUrl: null, mediaType: 1, renderLargerThumbnail: false }}}, { quoted: m })
await m.react("📍")
 }
}
