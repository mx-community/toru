...
try {
await m.react("⏰")
const res = await axios(`https://api-hasumi.vercel.app/api/youtube/ytmp4v3?url=${text}`)
...
await conn.sendMessage(m.chat, { audio: { url: data.dl_url }, mimetype: "audio/mpeg", fileName: toru.title }, { quoted: m })
await m.react("✅")
} catch (e) {
