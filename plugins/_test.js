...
if (!texto === text) return conn.sendMessage(m.chat, { text: `Texto faltante, escriba un texto principal.` }, { quoted: m })
if (!titulo === text) return conn.sendMessage(m.chat, { text: `Titulo faltante, escriba el titulo de mensaje referente.` }, { quoted: m })
if (!descripcion === text) return conn.sendMessage(m.chat, { text: `Descripcion faltante, escriba una descripción.` }, { quoted: m })
