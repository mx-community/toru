...
⚶ *Balance:*
\t${toem} ${currency} : *+${ganado.toLocaleString()}*
\t${toem2} ${currency2} : *+${ganado2.toLocaleString()}*
...
//conn.sendMessage(m.chat, { text: respuesta, mentions: [m.sender], contextInfo: { externalAdReply: { title: "々 P E S C A D E R O 々", body: botname, thumbnail: thumb, sourceUrl: null, mediaType: 1, renderLargerThumbnail: false }}}, { quoted: m })
} else {
...
//conn.sendMessage(m.chat, { text: noXd, mentions: [m.sender], contextInfo: { externalAdReply: { title: "El mercader pescadero.", body: "¡Tengo clientes que atender, reune 10 pescados y vuelve!", thumbnail: fotoEx, sourceUrl: null, mediaType: 1, renderLargerThumbnail: false }}}, { quoted: m })
 }
}
