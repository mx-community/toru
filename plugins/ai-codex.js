...
if (!text) return conn.sendMessage(m.chat, { text: `ᗢ Proporcione un texto para hablar con CODEX.\n- Especialmente si es tema de programación.\n\n\t⚶ Por ejemplo:\n*${usedPrefix + command}* Haz un codigo en HTML de hola mundo...` }, { quoted: m })
await m.react("⏰")
try {
