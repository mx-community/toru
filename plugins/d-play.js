...
{ url: () => fetch(`https://api-hasumi.vercel.app/api/youtube/ytmp3v3?url=${userVideoData.url}`).then((res) => res.json()), extract: (data) => ({data: data.status ? data.data.results.dl_url : null, isDirect: false}) },
...
{ url: () => fetch(`https://api-hasumi.vercel.app/api/youtube/ytmp4v3?url=${userVideoData.url}`).then((res) => res.json()), extract: (data) => ({data: data.status ? data.data.results.dl_url : null, isDirect: false}) },
